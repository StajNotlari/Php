...
<body>
  ...
  <div id="content">
    ...
    <div class="container">
      <a href="haber_ekle.php"><button style="width:100%;" type="button" class="btn btn-success">Ekle</button></a>
        ...
        <table class="table table-striped table-hover">
          ...
          ?>
            <tr>
              ...
              <td scope="col"><img width="90px;" height="60px;" src="resimler/<?php echo $kayit["picture"] ?>"/></td>
              ...
              <td>
                <a href="haber_sil.php?id=<?= $kayit["ID"] ?>"> <button type="button" class="btn btn-outline-danger btn-sm">SİL</button></a>
                <a href="haber_duzenle.php?id=<?= $kayit["ID"] ?>"><button type="button" class="btn btn-outline-primary btn-sm" style="margin-top:5px;">Düzenle</button></a>
              </td>
            </tr>
